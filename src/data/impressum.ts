/** Client-supplied Impressum copy. */

export const impressumCopy = {
  ddgLead: "Angaben gemäß § 5 DDG.",
  representedByLabel: "Vertreten durch",
  disputeTitle: "Verbraucherstreitbeilegung / Universalschlichtungsstelle",
  dispute:
  ...
  privacyBeforeLink: "Unter dem folgenden Link finden Sie unsere",
